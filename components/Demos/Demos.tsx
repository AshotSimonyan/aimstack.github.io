...
const Demos = () => {
    return (
        <DemosStyle id='demos'>
            <Container>
                <Text as='h2' size={9} css={{textAlign: 'center'}}>Demos</Text>
                <Text as='p' size={4} css={{margin: '0 auto 60px', textAlign: 'center', maxWidth: '560px', '@bp1': {marginBottom: '44px'}}} >Play with Aim before installing it!
                        ...
                        return (
                            <DemosItem key={name}>
                                <Link href={url} target='_blank'>
                                    ...
                                    <div className='inner'>
                                        <Text as='h4' size={4} css={{marginBottom: '$2', fontWeight: '$4'}} >{title}</Text>
