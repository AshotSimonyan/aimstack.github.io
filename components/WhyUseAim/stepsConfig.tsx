...
const stepsConfig: ISteps[] = [
    ...
    {
        name: 'debugging',
        title: 'Deep dive into details of each run for <strong>easy debugging</strong>',
        list: [
    ...
    {
        name: 'governance',
        title: 'Have all relevant information centralized for <strong>easy governance</strong>',
        list: [
