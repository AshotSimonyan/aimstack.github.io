    ...
    return (
        <SubscribeStyle>
            <Container>
                <SubscribeInner>
                    <Left>
                        <Text as='h2' size={9} css={{marginBottom: '$4'}} >Subscribe to Our Newsletter</Text>
                        <Text size={4} css={{marginBottom: '$6'}}>Subscribe to our newsletter to receive regular updates about our latest releases, tutorials and blog posts!</Text>
