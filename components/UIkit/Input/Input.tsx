...
type InputProps = InputHTMLAttributes<HTMLInputElement> & CSS & InputPropsBasics

// const Input = forwardRef<HTMLAnchorElement | HTMLButtonElement, ButtonProps>(({children, ...rest}, ref) => {
const Input = forwardRef<HTMLInputElement, InputProps>(({className, errorMessage,...rest}, ref) => {
    return (
